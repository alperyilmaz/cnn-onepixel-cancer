...
def load_results():
    with open('results/untargeted_results.pkl', 'rb') as file:
        untargeted = pickle.load(file)
    with open('results/targeted_results.pkl', 'rb') as file:
...
def checkpoint(results, targeted=False):
    ...
    with open('results/' + filename + '_results.pkl', 'wb') as file:
